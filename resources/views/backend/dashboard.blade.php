        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h4 class="my-courses-title">@lang('labels.backend.dashboard.my_courses')</h4>
                    </div>
                    ...
                    <div class="col-md-4">
                        <!-- <div class="best-course-pic-text position-relative border">
                            <div class="best-course-pic position-relative overflow-hidden" @if($item->course_image !=
                        ...
                        <div class="img-card iCard-style1">
                            <div class="card-content">
                                <div class="card-image">                 
                                    ...
                                    <img src="{{ url('storage/uploads/'.$item->course_image)}}" />
                                    @endif
                                ...
                                <div class="card-text course-card-text">
                                    <h5>
                                        <a href="{{ route('courses.show', [$item->slug]) }}">{{$item->title}}</a>
                                    </h5>
