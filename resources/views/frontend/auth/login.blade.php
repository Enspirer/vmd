...
@section('content')
    <div class="container login" style="margin-bottom: 5rem;">
        <div class="row align-items-center">
            <div class="col-6">
                <h3 class="text-center mb-2">Login to your account.</h3>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-6 text-end">
                        <a href="{{ route('frontend.auth.password.reset') }}" class="text-decoration-none text-dark" style="font-size: 0.8rem;">Forgot Your Password?</a>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <a href="" class="text-decoration-none text-dark">
                            <div class="row align-items-center bg-white p-2 shadow">
                                <div class="col-4">
                                    <img src="{{ url('img/frontend/auth/fb.png') }}" alt="" class="img-fluid" style="height: 2rem;">
                                </div>
                                <div class="col-8">
                    ...
                    <div class="col-4">
                        <a href="" class="text-decoration-none text-dark">
                            <div class="row align-items-center bg-white p-2 shadow">
                                <div class="col-4">
                                    <img src="{{ url('img/frontend/auth/google.png') }}" alt="" class="img-fluid" style="height: 2rem;">
                                </div>
                                <div class="col-8">
            ...
            <div class="col-6">
                <img src="{{ url('img/frontend/auth/login.png') }}" alt="" class="img-fluid w-100" style="height: 35rem; object-fit: cover;">
            </div>
        </div>
    </div>
