    ...
    <div class="container login" style="margin-top: 3rem; margin-bottom: 5rem;">
        <div class="row align-items-center">
            <div class="col-7">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <label for="qualification" class="form-label mb-0 me-3 form-label">Educational Qualification</label>                                    
                        <input type="text" class="form-control text-white" id="qualification" name="qualification" required> 
                    </div>
            ...
            <div class="col-5">
                <img src="{{ url('img/frontend/auth/candidate.png') }}" alt="" class="img-fluid w-100" style="height: 35rem; object-fit: cover;">
            </div>
        </div>
    </div>
