        ...
        <div class="main-content-wrapper">
                ...
                <div class="learn-box">
                    ...
                    <div class="course-list-box">
                        <div class="inner-box">
                            <ul>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">FULLY UPDATED FOR SAA-CO2:Pass the AWS Certified Solutions
                                    Architect Associate Certification</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Perform Real-World Solution Architecture on AWS
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Learn the Serverless Fundamantals (Lambda, DynamoDB, Cognito, API
                                    Gateway)</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Understand the Well Architected Framework, DIsaster Recovery</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">|Secure your entire AWS Cloud using KMS, IAM, Policies & SSM</span>
                                </li>
                            </ul>
                        </div>
                        <div class="inner-box">
                            <ul>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">All 600+ slides available as downloadable PDF</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Learn the AWS Fundamantals (EC2, ELB, ASG, RDS, ElastiCache, S3)</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Analyze 10+ Solution Architectures (traditional & serverless)</span>
                                </li>
                                <li>
                                    <span><img class="check-icon" src="{{ url('img/frontend/individual_courses/checked.png')}}" alt=""></span><span class="learn-task">Master all the differences of Databases on AWS</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-md-4 side-cards">
                <div class="top-card i-course-card">
                    <img class="side-mg" src="{{ url('img/frontend/individual_courses/individal_course_one.png')}}"
                        alt="add to card">
