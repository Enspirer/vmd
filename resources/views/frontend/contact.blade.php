...
@section('content')
    ...
    <div class="container" style="margin-top: 4rem; margin-bottom : 5rem;">
        <div class="row position-relative">
            ...
            <p class="text-center position-absolute" style="opacity: 0.04; top: -2.1rem; font-size: 6rem; line-height: 1.2; z-index: -1; font-weight: 800">CONTACT US</p>
        </div>
    </div>
    ...
    <div class="container" style="margin-bottom : 7rem;">
        <div class="row align-items-center">
            <div class="col-6">
                <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Central%20road,%20pottuvil&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.whatismyip-address.com/divi-discount/"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:100%;}</style><a href="https://www.embedgooglemap.net">embed map in email</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:100%;}</style></div></div>
            </div>
            ...
            <div class="col-6">
                ...
                <p class="mb-3" style="font-size: 0.8rem;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maiores quod earum voluptates consequatur. Aspernatur perspiciatis.</p>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12 main-office ms-3 mb-5">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-1 pe-0">
                                <img src="{{url('img/frontend/contact_us/fax.png')}}" alt="" style="height: 1rem; width: 1rem;">
                            </div>
                            <div class="col-11 ps-0">
                                <p>0094 11 5526575</p>
                            </div>
    ...
    <div class="container" style="margin-top: 4rem; margin-bottom : 5rem;">
        <div class="row position-relative">
            ...
            <p class="text-center position-absolute" style="opacity: 0.04; top: -2.1rem; font-size: 6rem; line-height: 1.2; z-index: -1; font-weight: 800">GET IN TOUCH</p>
        </div>
    </div>
    ...
    <div class="container" style="margin-bottom: 7rem;">
        <div class="row">
            ...
            <div class="col-6">
                <img src="{{ url('img/frontend/contact_us/contact.png') }}" alt="" class="img-fluid w-100" style="height: 35rem; object-fit: cover;">
            </div>
        </div>
    </div>
