...
<div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="featured-text-box">
                                ...
                                <p style="overflow: hidden;text-overflow: ellipsis;height: 119px;">
                                    {{ strip_tags($fea_courses->description) }}
                                </p>
                                ...
                                <div class="swiper-slide">
                                    <div class="slide-inner-wrapper">
                                        <div class="card-img-area">
                                            <img src="{{ asset('storage/uploads/'.$pop_courses->course_image) }}"
                                                alt="">
                                        </div>
                                        <div class="card-content-area">
                                            <div class="card p-4 slider-card">
                                                ...
                                                <div class="row  mb-3 align-items-center">
                                                    <div class="col-6 border-right">
                                                        <p><i class="bi bi-layers-fill"
                                                                ...
                                                                style="color: #150D6D">{{\App\Models\Lesson::where('course_id',$pop_courses->id)->count()}}
                                                                Lessons</span></p>
                                                    </div>
                                                    <div class="col-6">
                                                        <p><span class="fw-bold ms-2 time-and-lessons-small"
                                                                style="color: #150D6D">EXP: {{$fea_courses->expire_at}}
                                                            </span></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" price-enroll-box  card-box">
                                                    ...
                                                    @else
                                                    <h3 class="fw-bold mb-3 course-price-card" style="color: #0763E5">
                                                        ${{$pop_courses->price}}</h3>
                                                    @endif

                                                    <form action="{{ route('courses.show',$pop_courses->slug) }}"
                                                        method="get">
                                                        <button type="submit" class="card-enroll-btn">Enroll
                                                            Now</button>
                                                    </form>
                                                </div>
                                            </div>
   ...
   text-overflow: ellipsis; height: 100px;">{{$pop_courses->meta_description}}</p>
                                            ...
                                            <a href="{{ route('courses.show',$pop_courses->slug) }}"
                                                class="btn enroll-blue-btn">Entroll Now</a>
                                        </div>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="slide-inner-wrapper">
                                        <div class="card-img-area">
                                            <img src="{{ asset('storage/uploads/'.$trend_courses->course_image) }}"
                                                alt="">
                                        </div>
                                        <div class="card-content-area">
                                            <div class="card p-4 slider-card">
                                        ...
                                        <div class="hover-card-popup">
                                            ...
                                            <ul class="card-popup-list">
                                                <li><span><i class="fas fa-check"></i></span>Build websites and webapps
                                                </li>
                                                <li><span><i class="fas fa-check"></i></span>Build HTML-based mobile
                                                    apps
                                                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="course-list-item-details">
                        <h2>{{$all->title}}</h2>
                        <p style=" overflow: hidden;text-overflow: ellipsis;height: 100px;">{{$all->meta_description}}
                        </p>
